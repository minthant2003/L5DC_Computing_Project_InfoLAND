                ...
                <div class="row">
                    ...
                    <div id="course-content" class="col-md-9">
                        <div class="course-description">
                            ...
                            <div class="in-progress">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="course.php"><img src="upload/xcourse_01.png.pagespeed.ic.XTOvCuUmZu.png" alt=""
                                                    class="alignleft img-thumbnail" style="max-width:60px; margin: 0 10px">Web Design & Development</a>
                                            </td>
                                            <td>
                                                In progress
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="course.php"><img src="upload/xcourse_02.png.pagespeed.ic.PL7Wu2UcSB.png" alt=""
                                                    class="alignleft img-thumbnail" style="max-width:60px; margin: 0 10px">Network System Design & Development</a>
                                            </td>
                                            <td>
                                                In progress
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="course.php"><img src="upload/xcourse_03.png.pagespeed.ic.8e1MyY5M7i.png" alt=""
                                                    class="alignleft img-thumbnail" style="max-width:60px; margin: 0 10px">Programming Concepts & Logic</a>
                                            </td>
                                            <td>
                                                In progress
                                            </td>
                            ...
                            <div class="complete">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>                                        
                                        <tr>
                                            <td>
                                                <a href="course.php"><img src="upload/xcourse_04.png.pagespeed.ic.2rIKmUwjA7.png" alt=""
                                                    class="alignleft img-thumbnail" style="max-width:60px; margin: 0 10px">Cyber Security</a>
                                            </td>
                                            <td>
                                                Completed
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="course.php"><img src="upload/xcourse_05.png.pagespeed.ic.mrKpzOf8LX.png" alt=""
                                                    class="alignleft img-thumbnail" style="max-width:60px; margin: 0 10px">Cloud Computing</a>
                                            </td>
                                            <td>
                                                Completed
                                            </td>
                            ...
                            <hr class="invis">
                            <form action="profile.php" method="post">
                                <button type="submit" class="btn btn-danger" style="float:right;">Log Out from Account</button>
                            </form>
                        </div>
                    </div>
                </div>
