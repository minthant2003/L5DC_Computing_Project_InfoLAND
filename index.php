<?php
  ...
  // Remembered learner (Remember me)
  if (isset($_COOKIE['learner_id'])) {
    $sql = "SELECT * FROM learner WHERE Learner_ID=?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "i", $_COOKIE['learner_id']);
        ...
        <div class="tp-banner">
          <ul>
            ...
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_03.jpg" data-saveperformance="off" data-title="Slide">
              ...
              <div class="tp-caption slider_layer_01 text-center lft tp-resizeme" data-x="center" data-y="250" data-speed="1000" data-start="600" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000" style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;">InfoLAND Learning Platform
              </div>
              <div class="tp-caption slider_layer_02 text-center lft tp-resizeme" data-x="center" data-y="360" data-speed="1000" data-start="800" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000" style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;">Great Education Platform for New Learners,
                <br> with tons of various courses!
              </div>
              <div class="tp-caption text-center lft tp-resizeme" data-x="center" data-y="440" data-speed="1000" data-start="800" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000" style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"> <a href="profile.php" class="btn btn-primary">See Profile</a> <a href="shoppingCart.php" class="btn btn-default">Shopping Cart</a>
              </div>
            </li>
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_02.jpg" data-saveperformance="off" data-title="Slide">
              ...
              <div class="tp-caption slider_layer_04 text-center lft tp-resizeme" data-x="center" data-y="200" data-speed="1000" data-start="600" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="1000" style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><strong>InfoLAND Online Learning Platform</strong>
              </div>
        ...
        <div class="callout row">
          <div class="col-md-9 text-center">
            <h4><i class="fa fa-phone fa-3x alignleft"></i> For more inquires, simply make a contact to us. <i class="fa fa-chevron-right"></i>
              <br /><i class="fa fa-envelope"><a href="mailto:admin@InfoLAND.com">&nbsp;admin@InfoLAND.com</a></i>
            </h4>
          </div>
          <div class="col-md-3">
            ...
            <div class="content-widget">
              <div class="team-members row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_01.jpg.pagespeed.ic.uNKwi9Xmie.jpg" alt="teamMember1" class="img-responsive wow fadeInUp">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_02.jpg.pagespeed.ic.Foo3PN64df.jpg" alt="teamMember2" class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Adam DEO</h5>
                      <span>Programming Lecturer</span>
                      <p>Curabitur ultrices nec est nec vestibulum. Maecenas tincidunt pretium lacinia. Nullam purus
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_03.jpg.pagespeed.ic.Mw22RnI1eL.jpg" alt="teamMember3" class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jenny Kennedy</h5>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="upload/xteam_04.jpg.pagespeed.ic.equz9NTtM1.jpg" alt="teamMember4" class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jennifer DEO</h5>
                      <span>Network Lecturer</span>
                      <p>Curabitur ultrices nec est nec vestibulum. Maecenas tincidunt pretium lacinia. Nullam purus
