        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
              <a id="sign-out" class="dropdown-item" href="mail.php"><i class="mdi mdi-logout me-2 text-primary"></i> Signout </a>
            </div>
          </li>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="../students/students.php">Students</a></li>
          ...
          <div class="row">
            <div class="col-12 stretch-card grid-margin">
              <div class="card">
                <div class="card-body">
                  <div class="card-title">Mail Compose</div>
                  <form action="#" method="post" enctype="multipart/form-data" class="forms-sample">
                    <div class="form-group">
                      <label for="">Title</label>
                      <textarea class="form-control" id="" rows="4" placeholder="Enter the Mail Title"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="">Body</label>
                      <textarea class="form-control" id="" rows="12" placeholder="Enter the Mail Body"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Certificate</label>
                      <input type="file" name="" class="file-upload-default" disabled>
                      <div class="input-group col-xs-12">
                        <input type="text" class="form-control file-upload-info" disabled="" placeholder="Certificate">
                        <span class="input-group-append">
                          <button class="file-upload-browse btn btn-gradient-primary" type="button" disabled>Certificate</button>
                        </span>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-gradient-primary me-2">Compose</button>
